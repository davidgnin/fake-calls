...
var _main = require('./query-ui/main');

var _main2 = _interopRequireDefault(_main);

var _main3 = require('./query-ui/datetimepicker/main');
...
var createGUI = function createGUI(config) {
  var id = (0, _utils.generateID)('fake-calls-');
  config.container.innerHTML = (0, _utils.generateHTML)(id);

  var gui = {};
  var selector = '#fake-calls-' + id;
  ...
  config.fromPicker = (0, _main4.default)({
    input: gui.from
  });
  config.toPicker = (0, _main4.default)({
    input: gui.to
  });
  config.keysUI = (0, _main2.default)({
    custom: 'string',
